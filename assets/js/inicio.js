const productos = [
    ...
    { nombre: 'Bolsas horno', descripcion: '', precioARS: 0, imagen: 'https://media.istockphoto.com/id/148157090/es/foto/bolsa-de-horno.jpg?s=612x612&w=0&k=20&c=mMx0JZc2bdplKFz4VyIuXVyabZED3vFFLOuPvWsvSUc=', ruta: 'productos\\bolsas\\horno', categoria: 'Bolsas', boton: '<span id="ocultarstock"> Ver Producto</span>', stockHtml: '<span class="sin-stock" id="sin-stock-bh">SIN STOCK</span>' },
    ...
    { nombre: 'Bolsas Ziploc', descripcion: '', precioARS: 0, imagen: 'https://http2.mlstatic.com/D_685587-MLA73680856280_012024-O.jpg', ruta: 'productos\\bolsas\\ziploc', categoria: 'Bolsas', boton: '<span id="ocultarstock"> Ver Producto</span>', stockHtml: '<span class="sin-stock sin-stockz" id="sin-stock-bh">SIN STOCK</span>' },
    // Cajas
    { nombre: 'Caja De Desayuno', descripcion: '', precioARS: 0, imagen: 'https://camoga.ar/media/catalog/product/cache/17183a23c5d57b885c9e1f3d66234d68/1/8/18020722_caja_para_desayuno_con_visor_30x30x12_2_.jpg', ruta: 'productos\\cajas\\desayuno', categoria: 'Cajas', boton: '<span id="ocultarstock"> Ver Producto</span>', stockHtml: '<span class="sin-stock sin-stockdes" id="sin-stock-bh">SIN STOCK</span>' },
    ...
    { nombre: 'Caja De Ravioles', descripcion: '', precioARS: 0, imagen: 'https://dpack.com.ar/web/image/product.template/399/image_1024?unique=fc262e0', ruta: 'productos\\cajas\\ravioles', categoria: 'Cajas', boton: '<span id="ocultarstock"> Ver Producto</span>', stockHtml: '<span class="sin-stock sin-stockrav" id="sin-stock-bh">SIN STOCK</span>' },
    ...
    { nombre: 'Tiras de Cartón Satinadas', descripcion: '', precioARS: 0, imagen: 'https://www.flexipack.com.ar/Image/0/600_750-tiras_carton.jpg', ruta: 'productos\\carton\\tirascs', categoria: 'Carton', boton: '<span id="ocultarstock"> Ver Producto</span>', stockHtml: '<span class="sin-stock sin-stocktcs" id="sin-stock-bh">SIN STOCK</span>' },
    ...
    { nombre: 'Estallidos', descripcion: '', precioARS: 0, imagen: 'https://papelerapierrastegui.com.ar/assets/images/Fotos%20productos%20papelera%20para%20catálogo/LIBRERÍA/estallidos.jpg', ruta: 'productos\\libreria\\estallidos', categoria: 'Libreria', boton: '<span id="ocultarstock"> Ver Producto</span>', stockHtml: '<span class="sin-stock" id="sin-stock-bh">PENDIENTE</span>' },
    ...
    { nombre: 'Máquina De Mótex', descripcion: '', precioARS: 0, imagen: 'https://papelerapierrastegui.com.ar/assets/images/Fotos%20productos%20papelera%20para%20catálogo/LIBRERÍA/maquina%20motex.jpg', ruta: 'productos\\libreria\\maquinamotex', categoria: 'Libreria', boton: '<span id="ocultarstock"> Ver Producto</span>', stockHtml: '<span class="sin-stock" id="sin-stock-bh">SIN STOCK</span>' },
    ...
    { nombre: 'Voligoma', descripcion: '', precioARS: 0, imagen: 'https://http2.mlstatic.com/D_NQ_NP_793654-MLU73983277266_012024-O.webp', ruta: 'productos\\libreria\\voligoma', categoria: 'Libreria', boton: '<span id="ocultarstock"> Ver Producto</span>', stockHtml: '<span class="sin-stock" id="sin-stock-bh">SIN STOCK</span>' },
    // Papel
    ...
    { nombre: 'Sorbetes Papel', descripcion: '', precioARS: 0, imagen: 'https://papelerapierrastegui.com.ar/assets/images/Fotos%20productos%20papelera%20para%20catálogo/CUBIERTOS-PLATOS/images.jfif', ruta: 'productos\\sorbetes\\papel', categoria: 'Sorbetes', boton: '<span id="ocultarstock"> Ver Producto</span>', stockHtml: '<span class="sin-stock" id="sin-stock-bh">SIN STOCK</span>' },
