const productos = [
    ...
    // Cajas
    { nombre: 'Caja De Sandwich', descripcion: '', precioARS: 0, imagen: 'https://media.istockphoto.com/id/1351502094/es/foto/textura-de-superposici%C3%B3n-grunge-oscura-en-tonos-grises-l%C3%ADneas-de-pintura-din%C3%A1micas-manchas-en.jpg?s=612x612&w=0&k=20&c=QPSLJq_6xwqxPN-jityf2qjv91vY7aORctQq01-mHLc=', ruta: 'productos\\bolsas\\ziploc', categoria: 'Bolsas', stockHtml: '<span class="sin-stock sin-stockz" id="sin-stock-bh">Próximamente</span>' },
