const productos = [
    ...
    // Cajas
    { nombre: 'Caja De Desayuno', descripcion: '', precioARS: 0, imagen: 'https://camoga.ar/media/catalog/product/cache/17183a23c5d57b885c9e1f3d66234d68/1/8/18020722_caja_para_desayuno_con_visor_30x30x12_2_.jpg', ruta: 'productos\\cajas\\desayuno', categoria: 'Cajas', boton: 'Ver Producto'stockHtml: '<span class="sin-stock" id="sin-stock-bh">SIN PRECIO</span>' },
    { nombre: 'Caja De Sandwich', descripcion: '', precioARS: 0, imagen: 'https://biopackaging.com.ar/wp-content/uploads/2022/01/estuche-mediano-sandwich.jpg', ruta: 'productos\\cajas\\sandwich', categoria: 'Cajas', boton: 'Ver Producto', stockHtml: '<span class="sin-stock" id="sin-stock-bh">SIN PRECIO</span>' },
