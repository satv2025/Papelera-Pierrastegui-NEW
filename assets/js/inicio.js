const productos = [
    ...
    // Cajas
    { nombre: 'Caja De Desayuno', descripcion: '', precioARS: 0, imagen: 'https://camoga.ar/media/catalog/product/cache/17183a23c5d57b885c9e1f3d66234d68/1/8/18020722_caja_para_desayuno_con_visor_30x30x12_2_.jpg', ruta: 'productos\\cajas\\desayuno', categoria: 'Cajas', boton: 'Ver Producto' },
    { nombre: 'Caja De Sandwich', descripcion: '', precioARS: 0, imagen: 'https://biopackaging.com.ar/wp-content/uploads/2022/01/estuche-mediano-sandwich.jpg', ruta: 'productos\\cajas\\sandwich', categoria: 'Cajas', boton: 'Ver Producto', },
    ...
    { nombre: 'Cucharita', descripcion: '', precioARS: 0, imagen: 'https://papelerapierrastegui.com.ar/assets/images/Fotos%20productos%20papelera%20para%20catálogo/CUBIERTOS-PLATOS/spoon3_16_9.png', ruta: 'productos\\cubiertos\\cucharita', categoria: 'Cubiertos', boton: 'Ver Producto' },
    { nombre: 'Cuchillo Blanco', descripcion: '', precioARS: 0, imagen: 'https://papelerapierrastegui.com.ar/assets/images/Fotos%20productos%20papelera%20para%20catálogo/CUBIERTOS-PLATOS/knife1_16_9.png"', ruta: 'productos\\cubiertos\\cuchillos\\blanco', categoria: 'Cubiertos', boton: 'Ver Producto' },
    { nombre: 'Cuchillo Negro', descripcion: '', precioARS: 0, imagen: 'https://papelerapierrastegui.com.ar/assets/images/Fotos%20productos%20papelera%20para%20catálogo/CUBIERTOS-PLATOS/knife2_16_9.png', ruta: 'productos\\cubiertos\\cuchillos/negro', categoria: 'Cubiertos', boton: 'Ver Producto' },
